            ...
            <p className='p2 generate-pdf-main-color'>Please identify your choices for your Living Will:</p>
                ...
                <tr>
                    ...
                    <th colSpan='2' className=" text-center pb-2">
                        <u className="p3">{$AHelper.capitalizeAllLetters(userDetailOfPrimary.memberName)}</u>
                    </th>
                    <th colSpan='2' className="  text-center pb-2">
                        <u className="p3">{$AHelper.capitalizeAllLetters(userDetailOfPrimary.spouseName)}</u>
                    </th>
                </tr>
