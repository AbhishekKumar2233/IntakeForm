...
const Accountant = (props) => {
     ...
     return (
         ...
         { userId && (userId != "null") &&   <div className="content">
          ...
          <div className="row">
          <div className="col-2 pt-2"><label>Accountant’s Full Name: </label></div>
          ...
          <div className="col-10"><input type="text"   id='fi-a-name' value={$AHelper.capitalizeAllLetters(data?.businessName)} /></div>
               </div>
     ...
     <div className="col-8">
          ...
          <div className="col-9"><input type="text"  id='fi-a-state' value={address?.data?.countyRef} /></div>
               </div>
     </div>
               </div>
     ...
     <div className="col-8">
          ...
          <div className="col-9"> 
          {contact?.contact?.mobiles?.map(mobileEle => <input type="text"   
     ...
     <div className="row">
          ...
          <div className="col-7">
            {contact?.contact?.emails?.map(emailEle => {
               return <input type="text" value={emailEle?.emailId} />
               })}
          </div>
        </div>
...
<       div className="col-6">  <label>Does your spouse use the same Accountant?</label> </div>
     ...
     <div className="col-8">
          <div className="row">
          <div className="col-7"><label>How long have you used this accountant?</label></div>
          <div className="col-5"><input type="text" value={metaData?.find((v)=>v.questionId == 115)?.response}  id='fi-a-line1' /></div>
          </div>
     </div>
               </div>
