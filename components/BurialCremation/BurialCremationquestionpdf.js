...
const BurialCremationQuestionpdf = (props, ref) => {
                    ...
                    <Col xs={18} sm={18} md={18} lg={16} xl={9}>
                        ...
                        {formLabelDatawithlabel && formLabelDatawithlabel?.response?.map((response) => {
                            ...
                            return (
                                <>
                                    {(name == 'Address') ?
                                     <> <h5 className='burial_h5'>{response?.subResponseData}</h5>

                                    </> 
                                    : <>
                                        <h5 className={`${(withlabel == "label933" || withlabel == "label934") ? "upperCasing burial_h5 " : "burial_h5"}`}>{inputVal}</h5>
                                    </>
                                    }
    ...
    const _questionAndAnswerRadio = (formLabelDatawithlabel, name, withlabel, setState) => {
        ...
        return (<>
            <div class="mt-4 w-100">
                <label style={{textAlign:"justify",fontSize: "12.3px", color:"#909090"}}>{formLabelDatawithlabel && formLabelDatawithlabel.question}{" "} </label>
    ...
    return (
        <>
            ...
            <div className="sumPhysician" style={{width:"150px"}}>
            ...
            {(formlabelData?.label464?.response?.find((item) => item.response == 'No')?.checked == true) && <>
                ...
                <div className='sumPhysician'>
                    ...
                    <ul className="pt-4 ps-2"><li className="head-2" style={{fontSize:"12px"}}>SUGGESTION:</li></ul>   
                    <ul className='ps-2'>
                        ...
                        <li style={{ textAlign: 'justify', color:"#909090"}}>
                ...
                <>
                    ...
                    {(formlabelData?.label1019?.response?.find((item) => item.response == 'No')?.checked == true) && <>
                        ...
                        {(formlabelData?.label1021?.response?.find((item) => item.response == 'No')?.checked == true) && <>
                            <p className='pt-2' style={{fontSize: "12.3px", color:"#909090"  }}>You may want to ask them to give you a copy of the trust or fund in which the purchase price has been placed. Federal Law requires them to provide you this information.</p>
                        </>}
...
const Question1020Values = ({ handleStateUpdate, ques1020Value }) => {
    konsole.log(ques1020Value, "quesdate")
        ...
        <>
           ...
           <div className="d-flex justify-content-between pt-3">
            <div className="sumPhysician" style={{width:"150px"}}>
                 ...
                 <h5>{$AHelper.capitalizeAllLetters(ques1020Value?.nameOfInsuranceCmp)}</h5>
                </div>
                <div className="sumPhysician" style={{width:"150px"}}>
                 <p>Contract Number</p>
                 <h5>{ques1020Value?.policyNo}</h5>
                </div>
                <div className="sumPhysician" style={{width:"170px"}}>
                 <p>Issue Date</p>
                 <h5>{ques1020Value?.issueDate ? moment(ques1020Value?.issueDate ).format("MM-DD-YYYY") : ''}</h5>
            </div>
            </div>
            ...
            <div className="sumPhysician" style={{width:"150px"}}>
                 <p>Contact Number</p>
                 <h5>{$AHelper?.formatPhoneNumber(ques1020Value?.contactNo)}</h5>
                </div>
                <div className="sumPhysician" style={{width:"150px"}}>
                 <p>Address</p>
                 <h5>{ques1020Value?.address}</h5>
                </div>
                <div className="sumPhysician" style={{width:"170px"}}>
                 <p>Website</p>
                 <h5 style={{wordBreak:"break-all"}}>{ques1020Value.website}</h5>
                </div>
            </div>
...
const Question1022Values = ({ handleStateUpdate, question1022Values }) => {
    ...
    return (
        <>
            ...
            <div className="sumPhysician" style={{width:"150px"}}>
                 <p>Name of Contact</p>
                 <h5>{$AHelper.capitalizeAllLetters(question1022Values?.nameOfContact)}</h5>
                </div>
                <div className="sumPhysician" style={{width:"150px"}}>
                 <p>Name of Company</p>
                 <h5>{$AHelper.capitalizeAllLetters(question1022Values?.nameOfCmp)}</h5>
                </div>
                <div className="sumPhysician" style={{width:"170px"}}>
                 <p>Contact Number</p>
                 <h5>{$AHelper?.formatPhoneNumber(question1022Values?.contactNo)}</h5>
            </div>
            </div>
            ...
            <div className="sumPhysician" style={{width:"150px"}}>
                 <p>Cell Number</p>
                 <h5>{$AHelper.formatPhoneNumber(question1022Values?.cellNo)}</h5>
                </div>
                <div className="sumPhysician" style={{width:"150px"}}>
                 <p>Address</p>
                 <h5>{question1022Values?.address}</h5>
                </div>
                <div className="sumPhysician" style={{width:"170px"}}>
                 <p>Website</p>
                 <h5 style={{wordBreak:"break-all"}}>{question1022Values.website}</h5>
               </div>
                </div>
...
export default forwardRef(BurialCremationQuestionpdf);